...
?><div class="well">
<center>
    <h1>Add Assignment</h1></center>
    {{Form::open(array('route'=>array('assignment.addDBEntry',$courseId,$sectionId)))}}
...
$(function() {
  $("#timedue").datepicker({format:'yyyy-mm-dd'});
        ...
        {{Form::submit('Add Assignment',['type' => 'button','class' => 'btn btn-lg btn-primary btn-block'])}}
    {{Form::close()}}
</center></div>
@stop